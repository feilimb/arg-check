...
public class ReservationRobot extends TimerTask
{
	...
	public ReservationRobot(String productId, Store store, String emailAddress) 
	{
	...
	public void run() 
	{
		try 
		{
			...
			for (int i = 0; i < 40; i++) 
			{
				_robot.keyPress(VK_TAB);
			}
			_robot.keyPress(VK_ENTER);
			//performClick(600, 470);			
			_robot.delay(8000);
...
//			_robot.keyPress(VK_ENTER);
	...
	{
		String storeStart = _store.getName().substring(0, 7);
		type(storeStart);
		_robot.keyPress(VK_ENTER);
	}
